...
<head>
    ...
    <script>
        ...
        /**
         * describe a global RazanPOS object
         * @param {object} ns
         */
        window.ns = {
            nsExtraComponents
        ...
        <div class="overflow-hidden flex flex-auto">
            ...
            <div id="dashboard-body" class="flex flex-auto flex-col overflow-hidden">
                ...
                <div class="p-2 text-xs flex justify-end text-gray-500">
                    {!! Hook::filter( 'ns-footer-signature', sprintf( __( 'You\'re using <a tager="_blank" href="%s" class="hover:text-blue-400 mx-1 inline-block">RazanPOS %s</a>' ), 'https://my.nexopos.com/en', config( 'nexopos.version' ) ) ) !!}
                </div>
            </div>
        </div>
    </div>
