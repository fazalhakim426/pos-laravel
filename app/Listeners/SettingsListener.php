    ...
    public function handle(SettingsSavedEvent $event)
    {
        ...
        if ($options->get('ns_workers_enabled') === 'await_confirm') {
            ...
            $this->notificationService->create([
                ...
                'description' => __('The workers has been enabled, but it looks like RazanPOS can\'t run workers. This usually happen if supervisor is not configured correctly.'),
