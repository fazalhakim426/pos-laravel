...
class TransactionService
{
    ...
    public function getTransactionAccountByCode($type): TransactionAccount
    {
        ...
        if (!empty($account)) {
             ...
             */
            switch ($type) {
                case TransactionHistory::ACCOUNT_CUSTOMER_CREDIT:
                    $label = __('Customer Credit Account');
                    break;
                case TransactionHistory::ACCOUNT_LIABILITIES:
                    $label = __('Liabilities Account');
                    break;
                case TransactionHistory::ACCOUNT_CUSTOMER_DEBIT:
                    $label = __('Customer Debit Account');
                    break;
                case TransactionHistory::ACCOUNT_PROCUREMENTS:
                    $label = __('Procurements Account');
                    break;
                case TransactionHistory::ACCOUNT_EQUITY:
                    $label = __('Equity Account');
                    break;
                case TransactionHistory::ACCOUNT_REFUNDS:
                    $label = __('Sales Refunds Account');
                    break;
                case TransactionHistory::ACCOUNT_REGISTER_CASHIN:
                    $label = __('Register Cash-In Account');
                    break;
                case TransactionHistory::ACCOUNT_REGISTER_CASHOUT:
                    $label = __('Register Cash-Out Account');
                    break;
                case TransactionHistory::ACCOUNT_SALES:
                    $label = __('Sales Account');
                    break;
                case TransactionHistory::ACCOUNT_SPOILED:
                    $label = __('Spoiled Goods Account');
                    break;
            }
    ...
    public function getConfigurations(Transaction $transaction)
    {
        ...
        if (ns()->canPerformAsynchronousOperations()) {
            ...
            $warningMessage = sprintf(
                __('Some transactions are disabled as RazanPOS is not able to <a target="_blank" href="%s">perform asynchronous requests</a>.'),
